							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<div class="dropdown-divider"></div>
										<form action="/tb_yii2020-master/backend/web/index.php?r=site%2Flogout" method="post">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="forms">
								<ul class="nav nav-collapse">
									<li>
										<form action="/tb_yii2020-master/backend/web/index.php?r=site%2Fform" method="post">
										<input type="hidden" name="_csrf-backend" value="<?= Yii::$app->request->csrfToken ?>">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									<li>
										<form action="/tb_yii2020-master/backend/web/index.php?r=site%2Fdemand" method="post">
											<input type="hidden" name="_csrf-backend" value="<?= Yii::$app->request->csrfToken ?>">
